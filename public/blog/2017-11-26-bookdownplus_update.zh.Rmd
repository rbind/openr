---
title: 'R bookdownplus 升级手记，以及北大论文模板'
author: 赵鹏
date: '2017-11-26'
slug: -bookdownplus-update
summary: "bookdownplus 自发布以来最大的一次升级，包含了北京大学学位论文的 bookdown 模板。"
tags:
  - R
  - LaTeX
  - bookdown
...
我还有一块心病，是北京大学学位论文的 [LaTeX 模板](https://github.com/CasperVector/pkuthss)，我迟迟没能转成 bookdown 模板。原因是这个 LaTeX 模板本身在我电脑上就编译不成功。这次不知怎么开了窍，突然被我搞定了，作为第 21 个模板，收进了 bookdownplus v.1.4.0 里。

![](https://raw.githubusercontent.com/pzhaonet/bookdownplus/master/inst2/showcase/bookdownplus_thesis_pku.jpg)

此外，新增了一下几个模板：

- 益辉制作了 [Chapman & Hall 出版社的模板](https://disq.us/url?url=https%3A%2F%2Fgithub.com%2Fyihui%2Fbookdown-crc%3A5wtgG3vpge_i9bq1JupLLfeTiOI&cuid=5083260)，现成的，我稍微改了一下。看上去是这样的：

![](https://raw.githubusercontent.com/pzhaonet/bookdownplus/master/inst2/showcase/bookdownplus_yihui_crc.jpg)


- 这提醒我，直接去 bookdown.org 找现成的嘛！于是找到了Eduardo García Portugués 写的 [A short course on nonparametric curve estimation](https://bookdown.org/egarpor/nonpar-eafit/)，是在 yihui_demo 模板基础上增加了一个自定义环境。
